...
/***** 超声波发射/接收比较器控制引脚 *****/
#define ULTRASONIC_RX_CMP_CTRL_PORT    GPIOD
#define ULTRASONIC_RX_CMP_CTRL_PIN     GPIO_Pin_11
#define ULTRASONIC_TX_CMP_CTRL_PORT    GPIOD
#define ULTRASONIC_TX_CMP_CTRL_PIN     GPIO_Pin_12
