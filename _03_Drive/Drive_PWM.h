...
#define ULTRASONIC_RX_CMP_ON()         GPIO_SetBits(ULTRASONIC_RX_CMP_CTRL_PORT, ULTRASONIC_RX_CMP_CTRL_PIN)
#define ULTRASONIC_RX_CMP_OFF()        GPIO_ResetBits(ULTRASONIC_RX_CMP_CTRL_PORT, ULTRASONIC_RX_CMP_CTRL_PIN)
#define ULTRASONIC_TX_CMP_ON()         GPIO_SetBits(ULTRASONIC_TX_CMP_CTRL_PORT, ULTRASONIC_TX_CMP_CTRL_PIN)
#define ULTRASONIC_TX_CMP_OFF()        GPIO_ResetBits(ULTRASONIC_TX_CMP_CTRL_PORT, ULTRASONIC_TX_CMP_CTRL_PIN)
