...
#define KeyValue_8          8
#define KeyValue_9          9
#define KeyValue_Point      10  // .
#define KeyValue_Back       11  // Back
#define KeyValue_Enter      12  // Enter
#define KeyValue_Add        13  // +
#define KeyValue_Minus      14  // -
#define KeyValue_Ride       15  // *
#define KeyValue_Div        16  // /
#define KeyValue_NumLock    17  // NumLock
#define KeyValue_Null       20  // 无按键按下
/* 私有结构体 --------------------------------------------------------------------------------*/
